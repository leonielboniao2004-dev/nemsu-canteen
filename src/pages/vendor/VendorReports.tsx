...
const VendorReports = () => {
  ...
  return (
    <VendorShell
      ...
      subtitle="Track sales, orders, and best-selling items."
      toolbar={
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-card border border-border rounded-2xl p-5">
          ...
          {series.every((d) => d.value === 0) ? (
            <div className="h-56 flex items-center justify-center text-sm text-muted-foreground">No sales in this range yet.</div>
          ) : (
