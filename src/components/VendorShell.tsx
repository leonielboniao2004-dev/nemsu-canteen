...
import {
  LayoutDashboard, Package, ClipboardList, Users, BarChart3, Settings as SettingsIcon,
  LogOut, Store, Menu as MenuIcon, X, Bell,
} from "lucide-react";
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/vendor/settings" className="hidden sm:flex items-center gap-3 pl-3 border-l border-border group" aria-label="Open settings">
              {session.avatarDataUrl ? (
                <img src={session.avatarDataUrl} alt={session.name} className="h-10 w-10 rounded-xl object-cover" />
              ) : (
