...
export const StudentSidebarLayout = ({
  children,
  title,
  subtitle,
  toolbar,
  ...
  return (
    <div className="min-h-screen bg-muted/30 flex">
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-40 w-72 bg-card border-r border-border flex flex-col transition-transform lg:translate-x-0 ${
      ...
      >
        ...
        <div className="p-4 space-y-3">
          {verified ? (
            <div className="bg-[hsl(var(--success))]/10 border border-[hsl(var(--success))]/20 rounded-xl p-3 flex items-start gap-2.5">
            ...
            <div className="bg-[hsl(var(--warning))]/10 border border-[hsl(var(--warning))]/20 rounded-xl p-3 flex items-start gap-2.5">
            ...
            <Link
              to="/settings"
              className="block bg-muted/40 border border-dashed border-border rounded-xl p-3"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/settings" className="hidden sm:flex items-center gap-3 pl-3 border-l border-border group" aria-label="Open settings">
              {session.avatarDataUrl ? (
                ...
                <div className="h-10 w-10 rounded-xl flex items-center justify-center text-sm font-bold text-primary-foreground" style={{ background: "var(--gradient-primary)" }}>
                  {initials}
                </div>
              )}
